 ...
 */
public class BillingAddressDeliveryActivity extends BaseActivity implements View.OnClickListener, ShippingDeliveryAddressItemCallback {
    ...
    private void initView() {
        ...
        txtTitle.setText("Billing Address");
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.txtContinue:
                if (listAddress.size() == 0) {
                    ...
                    for (int i = 0; i < listChosen.size(); i++) {
                        if (listChosen.get(i)) {
                            OrderSummary.billing_address_id = listAddress.get(i).getEntity_id();
                            updateBillingAddress(OrderSummary.billing_address_id + "");
                            break;
                        }
                    }
                }
            ...
            case R.id.lnlManageAddress:
                Intent intent = new Intent(BillingAddressDeliveryActivity.this, SettingAddressActivity.class);
...
//                WindowManager.LayoutParams.FLAG_DIM_BEHIND);
    ...
    private void updateBillingAddress(String shipping_address_id) {
        JSONObject object = new JSONObject();
        try {
            object.put("customer_id", CustomerController.getCurrentCustomer(this).getEntity_id());
            object.put("billing_address_id", shipping_address_id);
        ...
        UICallback callback = new UICallback() {
            ...
            public void onResult(boolean success, String data) {
                if (success) {
                    Intent intent = new Intent(BillingAddressDeliveryActivity.this, DeliveryTypeActivity.class);
        ...
        CartExecute.updateBillingAddress(this, callback, CartDetailController.getCurrentCartDetail(this).getEntity_id(), object.toString());
        showProgressDialog(false);
    }
            ...
            public void onResult(boolean success, String data) {
                if (success) {
                    try {
                        ...
                        CountryController.clearAll(BillingAddressDeliveryActivity.this);
                        for (int i = 0; i < array.length(); i++) {
                            ...
                            CountryController.insertOrUpdate(BillingAddressDeliveryActivity.this, country);
                        }
                        getAddressList();
                    } catch (JSONException e) {
                        e.printStackTrace();
