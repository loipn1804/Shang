...
public class TermActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sendEvent(getString(R.string.analytic_term), getString(R.string.analytic_in));
    ...
    protected void onDestroy() {
        super.onDestroy();
        sendEvent(getString(R.string.analytic_term), getString(R.string.analytic_out));
    }
    ...
    private void initData() {
        if (StaticFunction.isNetworkAvailable(this)) {
            ...
            webView.loadUrl(Constant.TERMS_PAGE);
        } else {
