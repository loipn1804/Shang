...
import digimatic.shangcommerce.connection.api.BrandApi;
 ...
 */
public class BrandExecute {

    public static void getBrands(final Context context, final UICallback callback) {
