...
import digimatic.shangcommerce.connection.api.BannerApi;
 ...
 */
public class BannerExecute {

    public static void getAll(final Context context, final UICallback callback) {
